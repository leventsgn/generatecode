...
public sealed class WindowsServiceTemplate : IProjectTemplate
{
    ...
    private static string GenerateProjectFile(ProjectDefinition definition)
    {
        ...
        sb.AppendLine("    <PackageReference Include=\"Microsoft.Extensions.Hosting.WindowsServices\" Version=\"8.0.0\" />");
        sb.AppendLine("  </ItemGroup>");
        sb.AppendLine();
    ...
    private static string GenerateProgramFile(ProjectDefinition definition)
    {
        ...
        sb.AppendLine("builder.Services.AddWindowsService(options =>");
        sb.AppendLine("{");
        sb.AppendLine($"    options.ServiceName = \"{definition.ProjectName} Service\";");
        sb.AppendLine("});");
